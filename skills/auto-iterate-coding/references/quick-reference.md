...
| **Zoom Out** | 从系统高度理解代码，避免只见树木不见森林 | `references/zoom-out.md` |
| **Diagnose 六步** | reproduce → minimise → hypothesise → instrument → fix → regression-test | `references/feedback-loop.md` |
| **Triage** | Issue 优先级排序、scope 评估、session 分配 | `references/triage.md` |
| **Caveman Mode** | 超压缩通信模式，每轮输出 1-3 行电报风格 | `references/caveman-mode.md` |
