...
test("任务后技能沉淀写入 .agents skills 并维护 index 入口", () => {
  ...
  for (const expected of [
    ...
    "只沉淀可迁移、可行动、可验证的技能点",
    "Trigger / Signal、Do、Verify、Avoid、Boundary、Source Evidence",
  ]) {
    assertIncludes(skill, expected, "SKILL.md");
    assertIncludes(template, expected, "state-template.md");
...
test("英文 session 的 capture-skills 生成英文技能文档和索引", () => {
  ...
  assertIncludes(indexContent, "| Skill | Title | Key Trigger Signals | Source Session |", "skills index");
  ...
  const generatedContent = generatedFiles
    ...
    .join("\n");
  assertIncludes(generatedContent, "## Trigger / Signal", "generated skill");
  assertIncludes(generatedContent, "## Do", "generated skill");
  assertIncludes(generatedContent, "## Boundary", "generated skill");
  assertIncludes(generatedContent, "## Source Evidence", "generated skill");
