...
} = require("./stateValidationHelpers");
const { isImplementationMode } = require("./modeRules");
 ...
 * @returns {void}
 */
function validateLanguageModel(issues, language) {
...
/**
 * @param {ValidationIssue[]} issues
 * @param {unknown} traceability
 * @returns {void}
 */
function validateTraceabilityModel(issues, traceability) {
 ...
 * @returns {void}
 */
function validateDocumentationModel(issues, documentation) {
 ...
 * @param {{ session?: string }} [expected]
 * @returns {void}
 */
function validateSessionModel(issues, session, expected = {}) {
 ...
 * @returns {void}
 */
function validateTaskModel(issues, task) {
 ...
 * @param {ValidationIssue[]} issues
 * @param {unknown} mode
 * @param {ReadonlyArray<string>} validModes
 * @returns {void}
 */
function validateModeModel(issues, mode, validModes) {
 ...
 * @returns {void}
 */
function validateBudgetsModel(issues, budgets) {
...
/**
 * @param {ValidationIssue[]} issues
 * @param {unknown} watchdog
 * @param {{ deliveryVerifiability: string[]; requiredAction: string[] }} enumValues
 * @returns {void}
 */
function validateWatchdogModel(issues, watchdog, enumValues) {
 ...
 * @param {unknown} watchdog
 * @param {{ requirementStatus: string[] }} enumValues
 * @returns {StateObject[]}
 */
function validateRequirementsModel(issues, requirements, watchdog, enumValues) {
 ...
 * @returns {StateObject}
 */
function validateValidationModel(issues, validation, enumValues, isValidationHistoryEntry) {
 ...
 * @param {{ cleanupStatus: string[] }} enumValues
 * @returns {StateObject}
 */
function validateCleanupModel(issues, cleanup, enumValues) {
 ...
 * @returns {void}
 */
function validateDeliveryGateConsistencyModel(issues, state) {
 ...
 * @returns {StateObject[]}
 */
function phaseGateGates(phaseGate) {
 ...
 * @returns {void}
 */
function validateDecisionRequestModel(issues, request, taskProfile, state = {}) {
 ...
 * @returns {void}
 */
function validateValidationCommandsModel(issues, commands, isValidationHistoryEntry) {
 ...
 * @returns {void}
 */
function validateDeliveryDocsModel(issues, deliveryDocs, state) {
 ...
 */
function validateStateJsonModelCore(state, options) {
