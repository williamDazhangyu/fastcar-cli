 ...
 * @returns {void}
 */
function validateLanguageModel(issues: ValidationIssue[], language: unknown): void {
 ...
 * @returns {void}
 */
function validateTraceabilityModel(issues: ValidationIssue[], traceability: unknown): void {
 ...
 * @returns {void}
 */
function validateDocumentationModel(issues: ValidationIssue[], documentation: unknown): void {
 ...
 * @returns {void}
 */
function validateTaskModel(issues: ValidationIssue[], task: unknown): void {
 ...
 * @returns {void}
 */
function validateModeModel(issues: ValidationIssue[], mode: unknown, validModes: readonly string[]): void {
 ...
 * @returns {void}
 */
function validateBudgetsModel(issues: ValidationIssue[], budgets: unknown): void {
 ...
 * @returns {void}
 */
function validateWatchdogModel(
  issues: ValidationIssue[],
  watchdog: unknown,
  enumValues: Pick<EnumValues, "deliveryVerifiability" | "requiredAction">,
): void {
 ...
 * @returns {StateObject[]}
 */
function validateRequirementsModel(
  issues: ValidationIssue[],
  requirements: unknown,
  watchdog: unknown,
  enumValues: Pick<EnumValues, "requirementStatus">,
): StateObject[] {
 ...
 * @returns {StateObject}
 */
function validateCleanupModel(
  issues: ValidationIssue[],
  cleanup: unknown,
  enumValues: Pick<EnumValues, "cleanupStatus">,
): StateObject {
