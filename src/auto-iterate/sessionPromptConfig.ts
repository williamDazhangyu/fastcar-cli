...
export async function promptMode(defaultMode = "strict") {
...
export async function promptStrictConfig(options: StateObject = {}) {
...
export async function promptQuickConfig(options: StateObject = {}) {
...
export async function promptVerifyConfig(options: StateObject = {}) {
...
export async function promptDiagnoseConfig(options: StateObject = {}) {
...
export async function promptPlanConfig(options: StateObject = {}) {
...
export async function promptPrototypeConfig(options: StateObject = {}) {
...
export async function promptOptimizeConfig(options: StateObject = {}) {
...
export async function promptAutoIterateConfig(mode: string, options: StateObject = {}) {
  switch (mode) {
    case "quick":
...
export async function promptAutoIterateConfigFromFile(source: SourceChecklist, mode: string, options: StateObject = {}) {
