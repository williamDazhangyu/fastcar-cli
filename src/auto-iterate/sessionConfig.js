...
const { toRelativeSourcePath } = require("./sessionPaths");
const { isImplementationMode } = require("./modeRules");
const { inferLanguageFromAnswers } = require("../pipeline/language");
...
function getStyleConsolidationDefaultStatus(mode) {
...
module.exports = {
  ...
  formatNumber,
  getModeConfig,
  getStyleConsolidationDefaultStatus,
  normalizeLines,
