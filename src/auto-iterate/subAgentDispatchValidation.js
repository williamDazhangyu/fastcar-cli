 ...
 * @typedef {import("./stateMarkdownParsers").ParsedSubAgentItem} ParsedSubAgentItem
 * @typedef {{ issues: ValidationIssue[] }} SubAgentDispatchValidationResult
 */
...
/**
 * @param {ParsedSubAgentItem} agent
 ...
 * @returns {SubAgentDispatchValidationResult}
 */
