...
const { getSessionPaths, slugifySessionName, toRelative } = require("./sessionPaths");
const { readJsonFile, writeJsonFileAtomic } = require("./stateIO");
const { resolveStateFileForValidation } = require("./sessionStateValidation");
const { inferLanguageFromState, getLanguageText, languageCode } = require("../pipeline/language");
const { validationHistoryEntries } = require("../pipeline/validationCommands");
...
/**
 * @param {Record<string, any>} stateJson
 * @returns {import("./skillCapture").SkillCandidate[]}
 */
...
module.exports = {
  buildSkillMarkdown,
  buildSkillsIndexEntry,
  captureSkills,
  extractSkillCandidates,
  isHighValueSkillCaptureText,
  sanitizeSkillCaptureText,
  updateSkillsIndexFile,
  updateStateMarkdownSkillCapture,
  writeCapturedSkills,
};
