...
exports.NATURAL_LANGUAGE_EXAMPLES = void 0;
exports.getNaturalLanguageExampleSections = getNaturalLanguageExampleSections;
exports.renderNaturalLanguageExamples = renderNaturalLanguageExamples;
exports.showNaturalLanguageExamples = showNaturalLanguageExamples;
exports.NATURAL_LANGUAGE_EXAMPLES = [
    {
        title: "快速启动开发任务",
...
function getNaturalLanguageExampleSections(query) {
    const normalizedQuery = String(query || "").trim().toLowerCase();
    if (!normalizedQuery) {
        return exports.NATURAL_LANGUAGE_EXAMPLES;
    }
    return exports.NATURAL_LANGUAGE_EXAMPLES.filter((section) => {
        const haystack = [
            section.title,
            ...section.keywords,
            ...section.examples,
...
function renderNaturalLanguageExamples(query) {
