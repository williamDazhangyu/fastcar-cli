...
Success criteria:
${(0, sessionConfig_1.formatList)(answers.successCriteria, "not specified")}

Non-goals:
${(0, sessionConfig_1.formatList)(answers.nonGoals, "not specified")}

Allowed change scope:
${answers.allowedScope || "not specified"}

Compatibility requirements:
${(0, sessionConfig_1.formatList)(answers.compatibility, "not specified")}

Runnable validation commands:
${(0, sessionConfig_1.formatList)(answers.validationCommands, "not specified")}

External resources, secrets, database, network, or sandbox constraints:
${(0, sessionConfig_1.formatList)(answers.constraints, "not specified")}
