 ...
 * @returns {number | null}
 */
function getSnapshotBudgetLeft(state, mode) {
 ...
 * @returns {string}
 */
function stringValue(value, fallback = "无") {
 ...
 * @returns {string}
 */
function buildBudgetsSection(state) {
 ...
 * @returns {string}
 */
function buildWatchdogSection(state) {
 ...
 * @returns {string}
 */
function buildRequirementCoverageSection(state) {
 ...
 * @returns {string}
 */
function buildDefinitionOfDoneSection(state) {
 ...
 * @returns {string}
 */
function buildValidationSection(state) {
  const validation = asRecord(state.validation);
 ...
 * @returns {string}
 */
function buildCleanupSection(state) {
 ...
 * @returns {string}
 */
function buildDeliveryEvidenceSection(state) {
  const evidence = asRecord(state.deliveryEvidence);
  return [
 ...
 */
function buildFinalizedStateSections(state) {
  return [
 ...
 * @returns {string}
 */
function refreshFinalizedStateSections(content, state) {
  const evidence = asRecord(state.deliveryEvidence);
