 ...
 */
function validationHistoryItem(validation, iteration, phase) {
  return {
 ...
 * @returns {import("./types").ValidationHistoryEntry[]}
 */
function validationHistoryItems(validation, iteration, phase) {
 ...
 */
function validationPerCommand(validation) {
  const results = validation && Array.isArray(validation.results) ? validation.results : [];
 ...
 */
function normalizePostMergePostChangeStatus(status) {
  if (status === "passed") {
    return "passed";
  }
  if (status === "failed") {
 ...
 */
function applyPostMergeValidationState(state, validation, iteration) {
...
module.exports = {
  applyPostMergeValidationState,
  normalizePostMergePostChangeStatus,
  validationHistoryItem,
  validationHistoryItems,
  validationPerCommand,
};
